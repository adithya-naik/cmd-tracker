 ...
 * This is cleaner and works on bash/zsh
 * Note: fish uses its own FISH_HOOK_SCRIPT with different syntax
 */
const HOOK_SCRIPT = [
    "",
 ...
 *
 * @param {string} shell — "bash" , "zsh" or "fish"
